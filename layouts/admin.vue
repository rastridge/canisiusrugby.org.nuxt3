<template>
	...
	<div id="adminhome">
		...
		<b-sidebar id="sidebar-backdrop" title="CRC Admin Menu" backdrop shadow>

			<div class="px-3 py-2">

				<b-nav vertical class="w-35">
 ...
 -->
					...
					<b-nav-item v-if="checkPerm('content')" to="/admin/content" exact>
						Custom Pages
					</b-nav-item>

					<b-nav-item v-if="checkPerm('archive')" to="/admin/archive" exact>
						Document Archive
					</b-nav-item>
 ...
 -->
					...
					<b-nav-item v-if="checkPerm('news')" to="/admin/news" exact>
						News
					</b-nav-item>
					...
					<b-nav-item v-if="checkPerm('payments')" to="/admin/payments" exact>
						Payments
					</b-nav-item>
 ...
 -->
					...
					<b-nav-item v-if="checkPerm('sms')" to="/admin/sms" exact>
						Text Msgs
					</b-nav-item>

					<b-nav-item v-if="checkPerm('users')" to="/admin/users" exact>
						Admin Users
					</b-nav-item>

					<b-nav-item v-if="checkPerm('videos')" to="/admin/videos" exact>
						Videos
					</b-nav-item>

					<b-nav-item v-if="checkPerm('votes')" to="/admin/votes" exact>
						Votes
					</b-nav-item>

					<b-nav-item to="/admin/users/userlogout" exact>Log out</b-nav-item>
		...
		<div class="content-area">
			...
			<b-button v-b-toggle.sidebar-backdrop variant="outline-primary">
				Admin Menu
			</b-button>
