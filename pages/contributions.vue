<template>
  <div id="contributions">
    <Head>
      <Title>Canisius Rugby Club Contributions</Title>
    </Head>
    <div class="topsectioncenter">
      ...
      <div class="topsectionitem mb-2">
        <Card>
          <template #content>
            <p>
              Mail check payable to <br />Canisius Rugby Alumni Fund<br />
              <br />
              Canisius Rugby Club<br />
    ...
    <div class="my-simple-card-style">
      ...
      <div class="card w-full my-text-style">
        ...
        <hr />
        <p>
          Canisius Rugby Club Alumni Fund<br />
          The Canisius Rugby Club is a Tax Exempt 501c3 Organization. Your
