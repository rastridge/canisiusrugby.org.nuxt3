<template>
	<div class="add">
		...
		<form class="form">
			...
			<!-- opponent input-->
			<div class="form-group">
				<label class="col-sm-4 control-label" for="opponent">Opponent: </label>
				<div class="col-sm-5">
					<b-form-input
						id="opponent"
					...
					/>
					<span v-if="!$v.opponent.required" class="error"
			...
			<!-- referee input-->
			<div class="form-group">
				<label class="col-sm-4 control-label" for="referee"
					>Referee name:
				</label>
				<div class="col-sm-5">
					<input
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					...
					/>
					<span v-if="!$v.venue.required" class="error">Venue is required</span>
				</div>
			</div>
			...
			<!-- doc date -->
			<div class="col-sm-4">
				<label for="example-input">Date</label>
				...
				<p v-if="!$v.date.required" class="error">Date is required</p>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<b-form-datepicker
						...
						@input="setDate($event)"
					></b-form-datepicker>
					<span v-if="!$v.date.required" class="error">Date is required</span>
				</div>
			</div>
-->
			<!-- KO Time input-->
			<div class="form-group">
				<label class="col-sm-4 control-label" for="KO_time"> KO Time:</label>
				<div class="col-sm-4">
					<b-form-timepicker
						id="KO_time"
						v-model="KO_time"
					...
					<span v-if="!$v.KO_time.required" class="error"
			...
			<!-- Game type input-->
			<div class="form-group">
				<label class="col-sm-4 control-label" for="game_type_id">
					Game type:</label
				>
				<div class="col-sm-4">
					<select
					...
					>
						<option disabled value="">Select game type</option>
						<option
					...
					<br />
					<span v-if="!$v.game_type_id.required" class="error"
			...
			<!-- game level  -->
			<div class="form-group">
				<label class="col-sm-4 control-label" for="game_level">
					Game level:</label
				>
				<div class="col-sm-4">
					<select
					...
					>
						<option disabled value="">Select game level</option>
						<option value="A">A</option>
						<option value="B">B</option>
						<option value="C">C</option>
						<option value="D">D</option>
					</select>
					<span v-if="!$v.game_level.required" class="error"
			...
			<!-- points for -->
			<div class="form-group">
				<label class="col-sm-4 control-label" for="ptsFor"> Points for:</label>
				<div class="col-sm-2">
					<input
						id="ptsFor"
						v-model="ptsFor"
			...
			<!-- points against -->
			<div class="form-group">
				<label class="col-sm-4 control-label" for="ptsAgn">
			...
			<!-- image -->
			<div class="form-group">
				<label class="col-sm-4 control-label" for="game_image">
			...
			<div class="form-group">
				<label class="col-sm-6 control-label" for="reset"
					><div class="info-frame">
						If you want to select roster from a previous game? All current game
						info will be replaced.<span v-if="!date" style="color: red"
							>You must first set a date for this game</span
						>
					</div>
				</label>
				<div v-if="date" class="col-sm-2">
					Check here
					<input
						v-if="date"
						id="reset"
			...
			<div v-if="reset && date">
				<div class="form-group">
					<label class="col-sm-4 control-label" for="previous_game">
					...
					<div class="col-sm-6">
						...
						<div class="help-block inf-frame">
				...
				>
					...
					<tbody id="roster-tbody">
						<tr v-for="(item, index) in players" :key="item.position_id">
							...
							<td>
								<auto-complete
									:init="players[index].pln + ', ' + players[index].pfn"
									:items="suggestions"
